...
namespace HandySub.Common
{
    public static class Helper
    {
        ...
        public static void LoadHistory(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
            ...
            AutoSuggestBoxHelper.LoadSuggestions(sender, args, history);
        }
        #endregion
        ...
        public static bool IsInDoubleTapArea(DoubleTappedRoutedEventArgs e)
        {
            ...
            if (parent.GetType().Equals(typeof(Grid)) || parent.GetType().Equals(typeof(StackPanel)) || parent.GetType().Equals(typeof(ListViewItem)))
            {
                return true;
            }
            return false;
